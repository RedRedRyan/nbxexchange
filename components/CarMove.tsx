...
const CarMove = () => {
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            return () => root.removeEventListener("click", restart);
        }, root);
    ...
    return (
        <div
            ref={rootRef}
            className="auth-dashboard-preview absolute top-0 w-full h-full cursor-pointer"
        >
            <svg
                viewBox="0 0 850 420"
...
L -8.9 438.05"
                    ...
                    <path
                        id="ground_0_Layer0_0_1_STROKES"
                        stroke="#CC9966"
                        strokeWidth={4}
                        strokeLinejoin="round"
                        strokeLinecap="round"
